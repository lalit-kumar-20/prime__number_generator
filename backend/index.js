...
const PrimeNumberController = require('./PrimeNumberController');
const PrimeNumberRouter = require('./PrimeNumberRouter');
...
const controller = new PrimeNumberController(generator);
const router = new PrimeNumberRouter(controller);
